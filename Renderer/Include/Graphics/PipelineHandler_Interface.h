...
namespace Graphics
{
	...
	public:
		...
		virtual GRAPHICS_ERROR CreateBuffer(Utilz::GUID id, const Buffer& buffer) = 0;
		...
		virtual GRAPHICS_ERROR CreateShader(Utilz::GUID id, ShaderType type, const char* sourceCode, const char* entryPoint, const char* shaderModel) = 0;
		virtual GRAPHICS_ERROR CreateShader(Utilz::GUID id, ShaderType type, void* data, size_t size) = 0;
		...
		virtual GRAPHICS_ERROR CreateDepthStencilView(Utilz::GUID id, const DepthStencilView& view) = 0;
