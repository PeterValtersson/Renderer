...
#define RETURN_IF_GRAPHICS_ERROR_S(result, msg) if((result) < 0){Graphics::_lastErrorStringMsg = msg; return (Graphics::_lastError = Graphics::Graphics_Error{Graphics::_lastErrorStringMsg.c_str(), result, __FILE__, __LINE__});}
